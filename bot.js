...
//var arrRoll = ['8', '9', '10', '11', '12', '13', '14']; //Черные числа
...
setTimeout(rollEnable, 7000); //Ждет 7 секунд
num1++; //Если номер существует, то мы переносимся на след номер
}
}

setInterval(roll, 2000); //Каждые две секунды делаем запрос на главную функцию
